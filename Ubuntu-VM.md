...
If proceeded through the guide and the above command does not make the server reachable, try this instead: `pm2 start "node /home/ubuntu/foundry/resources/app/main.js --port=8080" --name "foundry"`.
