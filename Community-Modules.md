...
* Manifest: [https://gitlab.com/NoahZorbaugh/theatre/-/raw/master/module.json](https://gitlab.com/NoahZorbaugh/theatre/-/raw/master/module.json)

The fix for Foundry VTT 0.5 can be found here:
- [https://gitlab.com/mesfoliesludiques/theatre/-/raw/master/module.json](https://gitlab.com/mesfoliesludiques/theatre/-/raw/master/module.json)
...
* **Module Requirement(s)**: N/A
* **Module Conflicts**: None known.
* **Translation Support**: EN/JA (Full)
...
It currently supports the DnD5e Character and NPC sheets, Better NPC Sheet 5e, and Sky5e sheets, though adding support for other sheets is simple.
